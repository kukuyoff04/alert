...
def scrape_water_level():
    ...
    # --- ประกาศตัวแปร page และ browser ข้างนอก try ---
    browser = None
    page = None
    # ----------------------------------------------
    ...
    try:
        with sync_playwright() as p:
            ...
            # --- ⬇️ ขยายเวลารอเป็น 90 วินาที ⬇️ ---
            page.wait_for_selector(f"button:has-text('{STATION_NAME}')", timeout=90000) 
        ...
        # --- ⬇️ ส่วนที่เพิ่มเข้ามาสำหรับ Debug ⬇️ ---
        if page:
            try:
